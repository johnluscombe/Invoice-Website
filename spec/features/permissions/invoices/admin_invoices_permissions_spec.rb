...
describe 'Admin Invoices Permissions' do
  subject { page }
  ...
  describe 'admin' do
    ...
    describe 'invoices index of another admin' do
      before { visit user_invoices_path(other_admin) }
    ...
    describe 'new invoice of another admin' do
      before { visit new_user_invoice_path(other_admin) }
